$(document)['ready'](()=>{
    ...
    function _0x2b60c3(_0x1e5323) {
        ...
        if (_0x496673 == undefined || _0x1cedcf == undefined)
            _0x1e5323['failure']();
        else if (_0x496673 != $('#login-username')['val']())
            _0x1e5323['failure']();
        else
            $['ajax']({
                'url': 'api/login/',
                ...
                'success': _0x3f2e31=>{
                    ...
                    if (_0x3f2e31['time'] != _0x1cedcf)
                        _0x1e5323['failure']();
                    else if (!_0x2f5261(_0x1cedcf, _0x57dd37))
                        _0x1e5323['failure']();
                    else
                        _0x1e5323['success']();
                }
    ...
    function _0x3079b4() {
        $['ajax']({
            ...
            ,
            'error': _0x5194f8=>{
                if (_0x5194f8['status'] == 0x191)
                    alert('Auth\x20Failed!');
