...
var hex_chr = "0123456789abcdef";
    ...
    function rhex(_0x8e5dx3) {
        str = "";
        for (j = 0; j <= 3; j++) {
            str += hex_chr[charAt]((_0x8e5dx3 >> (j * 8 + 4)) & 0x0F) + hex_chr[charAt]((_0x8e5dx3 >> (j * 8)) & 0x0F)
        }
        ;return str
    }
    ...
    if (calcMD5(prompt(_0x29a9[5])) === "aa42b234cb05915716c1434058fe1aee16c14340cb059157aa42b234") {
        alert(_0x29a9[7])
    } else {
        alert(_0x29a9[8])
    }
